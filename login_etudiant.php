...
<head>
    ...
    <link rel="stylesheet" href="style/style-etudiant-login.css">
                        ...
                        <?php include('errors.php'); ?>
                            ...
                            <div class="form-group">
                                <div class="col-12 text-center">
                                    <a href="register_etudiant.php" style="color: red;font-weight: bold;">S'inscrire?</a>
                                </div>
                            </div>
                            <div class="row justify-content-center">
                                <input type="submit" value="Se Connecter" class="btn btn-primary" name="login">
                            </div>
